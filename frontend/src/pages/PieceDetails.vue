        ...
        <div class="grid grid-cols-5 gap-4">
            <div class="flex flex-col justify-between">
                <div>
                    ...
                    <h3 class="font-extrabold text-2xl cursor-pointer hover:underline"
                        @click="router.push(`/creator/${PIECE.creator.id}`)">U/{{PIECE.creator.firstname}} {{ PIECE.creator.lastname }}</h3>
                </div>
